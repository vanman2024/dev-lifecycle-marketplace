...
Use WebFetch to read the official documentation NOW before asking any questions:

1. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/overview
2. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/typescript
3. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/python
4. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/streaming-vs-single-mode
5. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/sessions
6. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/hosting
7. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/modifying-system-prompts
8. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/mcp
9. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/custom-tools
10. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/subagents
11. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/slash-commands
12. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/skills
13. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/cost-tracking
14. Use WebFetch to read: https://docs.claude.com/en/api/agent-sdk/todo-tracking

**CRITICAL**: Do NOT skip these WebFetch calls. Fetch ALL of them in parallel or sequentially. The documentation may have changed since your training data. Only after fetching these docs should you proceed to Step 2.
